# UI
 ...
 - `libs/react-kit/` — `@pensieve-react-kit/react-kit`
 ...
 ## Development (Storybook for @pensieve-react-kit/react-kit)
 
 Run Storybook (dev):
 
 ```sh
 pnpm nx run @pensieve-react-kit/react-kit:storybook
 # or
 ...
 ```sh
 pnpm nx test @pensieve-react-kit/react-kit
 ```
 
 Lint:
 
 ```sh
 pnpm nx lint @pensieve-react-kit/react-kit
 ```
 ...
 ```sh
 pnpm nx build @pensieve-react-kit/react-kit
 ```
 
 Build Storybook static site:
 
 ```sh
 pnpm nx run @pensieve-react-kit/react-kit:build-storybook
 # or
 ...
 - publish:react-kit — publishes `@pensieve-react-kit/react-kit` to the GitLab NPM registry
 ...
 ```sh
 pnpm nx show project @pensieve-react-kit/react-kit
 pnpm nx graph
 ```
