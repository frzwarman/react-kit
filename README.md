# K3martUi
 ...
 - `libs/react-kit/` — `@k3-universe/react-kit`
 ...
 ## Development (Storybook for @k3-universe/react-kit)
 
 Run Storybook (dev):
 
 ```sh
 pnpm nx run @k3-universe/react-kit:storybook
 # or
 ...
 ```sh
 pnpm nx test @k3-universe/react-kit
 ```
 
 Lint:
 
 ```sh
 pnpm nx lint @k3-universe/react-kit
 ```
 ...
 ```sh
 pnpm nx build @k3-universe/react-kit
 ```
 
 Build Storybook static site:
 
 ```sh
 pnpm nx run @k3-universe/react-kit:build-storybook
 # or
 ...
 - publish:react-kit — publishes `@k3-universe/react-kit` to the GitLab NPM registry
 ...
 ```sh
 pnpm nx show project @k3-universe/react-kit
 pnpm nx graph
 ```
