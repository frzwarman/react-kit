# K3martUi
 ...
 - `libs/react-kit/` — `@k3mart-js/react-kit`
 ...
 ## Development (Storybook for @k3mart-js/react-kit)
 
 Run Storybook (dev):
 
 ```sh
 pnpm nx run @k3mart-js/react-kit:storybook
 # or
 ...
 ```sh
 pnpm nx test @k3mart-js/react-kit
 ```
 
 Lint:
 
 ```sh
 pnpm nx lint @k3mart-js/react-kit
 ```
 ...
 ```sh
 pnpm nx build @k3mart-js/react-kit
 ```
 
 Build Storybook static site:
 
 ```sh
 pnpm nx run @k3mart-js/react-kit:build-storybook
 # or
 ...
 - publish:react-kit — publishes `@k3mart-js/react-kit` to the GitLab NPM registry
 ...
 ```sh
 pnpm nx show project @k3mart-js/react-kit
 pnpm nx graph
 ```
